...
<div class="page-centered">
  <div class="quiz-box">
    <h2>Как переводится на английский язык?</h2>
    <div id="question"><?= htmlspecialchars($correct['translation']) ?></div>
    <div id="answers">
      <?php foreach ($rows as $row): ?>
        <button class="answer-btn" onclick="checkAnswer('<?= htmlspecialchars($row['word']) ?>', this)">
...
<script>
const correct = '<?= strtolower(trim($correct['word'])) ?>';
let answered = false;
